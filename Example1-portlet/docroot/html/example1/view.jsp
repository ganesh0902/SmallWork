...
<portlet:actionURL var="save2" name="saveAction2"/>
								...
								<table>
									<tr>
										...
										<td style="height: 75px;"><input type="text"
											 name="quoteReference"
											style="height: 70%; width: 115%;" size="25" height="32%;" id="quote" readonly="readonly"></td>
									...
									<tr>
										...
										<td style="height: 170px;"><textarea
												style="width: 140%; height: 60%; margin-top: -90px;" id="customerAddress" name="customerAddress"></textarea>
												<i class='far fa-comment-dots' style='font-size:20px;position: relative;top: -35px;left: 310px;'>
												</td>
									</tr>
									<tr>
										<td><label class="error"
										...
										<i class='far fa-comment-dots' style='font-size:20px;position: relative;top: -100px;left: 260px;'>
										</td>
									</tr>
									<tr>
										<td><label
									...
									<tr>
										<td><label class="error"
											style="margin-top: -390px; margin-right: 0px; position: relative; right:-20px;font-size: 14px;" id="descriptionError">Description
												of Works </label></td>
										<td style="height: 170px;"><textarea
												style="width: 160%; height: 60%; margin-top: -680px;" id="description" name="description"></textarea></td>
									</tr>
								</table>								
								...
								<table>
									...
									<tr>
										...
										<td style="height: 75px; margin-top: 30px;"><input
											...
											style="height: 30%; width: 115%; margin-top: 60px;" size="22" onkeyup="lettersOnly(this)">
									...
									<tr>
										...
										<td style="height: 75px;"><input type="text"
											...
											style="height: 70%; width: 115%;" size="22" onkeyup="lettersOnly(this)">
											<i class='far fa-comment-dots' style='font-size:20px;position: relative;top: -31px;left: 270px;'>
											</td>
									</tr>
									<tr>
										...
										<td style="height: 170px;"><textarea
												style="width: 130%; height: 60%; margin-top: -80px;" id="lead" name="lead" class="error"></textarea>
									...
									<tr>
										...
										<td style="height: 170px;"><select
											style="height: 28%; width: 115%; margin-top: -230px;" id="location" name="location">
												<option value="select">Select</option>
										...
										<table style="margin-left: 100px;">
											<tr>
												<td><label style="margin-top: -60px;" class="error" id="contactError">Contact
														Name</label></td>
												<td style="height: 75px;"><input type="text" name="contactName"
											...
											<tr>
												...
												<td style="height: 75px;"><input type="text" name="phone"
												...
												<table>
													...
													<tr>
														<td><label style="margin-top: -20px;" class="error" id="projectDateError">Project
																Programme</label></td>
														<td><input type="text" 
															style="width: 90%; height: 59%; margin-top: -20px;" id="projectDate" name="projectDate">
															<span id="calendericon-pped" style="padding-left: 128px;position: relative;top: -35px;">&#128197;</span>		
															</td>
													</tr>
													<tr>
														...
														<td><input type="text" name="anticipatedDate"
															style="width: 90%; height: 59%; margin-top: -20px;" id="anticipatedDate" >
															<span id="calendericon-pped2" style="padding-left: 128px;position: relative;top: -35px;">&#128197;</span>
															</td>
													</tr>
												</table>
											</div>
												...
												<table>
													...
													<tr>
														<td><input type="text" name="endDate"
															style="width: 80%; height: 59%; position: relative; left: 20px; top: -60px;" id="endDate">
															<span id="calendericon-pped3" style="padding-left: 150px;position: relative;top: -94px;left: 10px;">&#128197;</span>
															</td>
													</tr>
													<tr>
														<td><input type="text" name="endDate2"
															style="width: 80%; height: 59%; position: relative; left: 20px; margin-top: -10px; top: -60px;" id="endDate2">														
															<span id="calendericon-pped4" style="padding-left: 150px;position: relative;top: -94px;left: 10px;">&#128197;</span>
	...
	<div id="parent" style="margin-right: 20%;margin-left: 20px;width: 550px;">
	...
	<div class="mydropzone1" id="child2" >
		<svg style="margin-left: 70px; margin-top: 20px" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-cloud-arrow-up" viewBox="0 0 16 16">
 				 <path fill-rule="evenodd" d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z"/>
  				 <path d="M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z"/>
		</svg>
		<p style="margin-left: 30px; margin-top: 0px;">Drop Files Here <span style="margin-left: 45px;">or</span> 
		
		</p>
			<button class="file mydropzone"  type="button" style=" margin-left: 25px; margin-top: -1px;width: 70%;">BrowseFiles</button>
	</div>
		<div id="child3">
		<br><br>
				...
				<div id="panel3"style="border: 1px; width: 96%; margin-left: 24px;">
					...
					<div style="width: 100%;">
						<label style="position: relative; top: 100px; left: 190px;">Bid
							Sheet</label>
						<!-- div
							style="display: flex; width: 54%; margin-left: 290px; margin-top: 30px;margin-bottom: 30px;background-color: green;"> -->
							<!-- <div style="flex: 5;"></div>
							<div style="flex: 2; border: 1px solid black;">gg
							...
							<%-- <small id="preOrder"><jsp:include page="Dropzone.jsp" />  
											 </small>  --%>
	...
	<div class="mydropzone2" id="child2" >
		<svg style="margin-left: 50px; margin-top: 20px" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-cloud-arrow-up" viewBox="0 0 16 16">
 				 <path fill-rule="evenodd" d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z"/>
  				 <path d="M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z"/>
		</svg>
		<p style="margin-left: 30px;">Drop Files Here <span style="margin-left: 45px;">or</span> 
		
		</p>
			<button class="file mydropzone"  type="button" style=" margin-left: 26px; margin-top: -1px;width: 70%;">BrowseFiles</button>
	</div>
		<div id="child3">
		<br><br>
			<button type="button" class="button1" style="margin-left:5px;">LinkToFile</button><br>
						...
						<div style="display: flex;">
							<div style="flex:6;">
								<div
									...
									<div style="flex: 3;height: 140px;border: 1px solid black;text-align: center;">
										<span><i class="fa fa-upload" style="font-size: 36px"></i></span>
										<label>Drop file here <br> or
										</label>
										<button
									...
									<div style="flex:4;width: 35%;border: 1px solid black;position: relative;top: -140px;left: 700px;">
										<div style="display: flex;">
											<div style="flex:5;height: 140px;border: 1px solid black;">
												<button class="btn btn-primary" style="position: relative;top: 50px;left: 50px;padding: 9px;">Generate</button>
											</div>
											<div style="flex:5;height: 140px;border: 1px solid black;">
						...
						<div style="display: flex;">
							...
							<table style="margin-top: -160px;margin-left: 45px;">
								...
								<tr>
									...
									<td><input type="text" name="projectCost" style="height: 34px;" id="projectcost" onkeyup="lettersDigit(this)"></td>
								</tr>
							</table>
							</div>
							<div style="flex:5">
								...
								<tr>
									...
									<td><input type="text" name="projectSell" style="height: 34px;" id="costs" onkeyup="lettersDigit(this)"></td>
								</tr>
							</table>
							</div>
						</div>
	...
	/* 	if(quote=="")
		{
			document.getElementById("quote").style.border="1px solid red";
			document.getElementById("quoteError").style.color="red";
			found=false;
		}
		else{
			document.getElementById("quote").style.border="1px solid black";
			document.getElementById("quoteError").style.color="black";
		} */
		if(projectName=="")
		{
