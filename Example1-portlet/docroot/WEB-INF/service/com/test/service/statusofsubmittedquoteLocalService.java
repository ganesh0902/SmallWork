...
/**
 * Provides the local service interface for statusofsubmittedquote. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dell
 * @see statusofsubmittedquoteLocalServiceUtil
...
public interface statusofsubmittedquoteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link statusofsubmittedquoteLocalServiceUtil} to access the statusofsubmittedquote local service. Add custom service methods to {@link com.test.service.impl.statusofsubmittedquoteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
