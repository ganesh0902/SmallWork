...
/**
 * The persistence utility for the statusofsubmittedquote service. This utility wraps {@link statusofsubmittedquotePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class statusofsubmittedquoteUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(statusofsubmittedquote statusofsubmittedquote) {
		getPersistence().clearCache(statusofsubmittedquote);
	}
	 ...
	 */
	public static List<statusofsubmittedquote> findWithDynamicQuery(
	 ...
	 */
	public static statusofsubmittedquote update(
		statusofsubmittedquote statusofsubmittedquote)
		throws SystemException {
		return getPersistence().update(statusofsubmittedquote);
	}
	...
	public static statusofsubmittedquote update(
		...
		return getPersistence().update(statusofsubmittedquote, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(statusofsubmittedquote);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(statusofsubmittedquotes);
	}
	...
	*/
	public static com.test.model.statusofsubmittedquote create(long sosqId) {
		return getPersistence().create(sosqId);
	}
	...
	*/
	public static com.test.model.statusofsubmittedquote remove(long sosqId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.NoSuchstatusofsubmittedquoteException {
		return getPersistence().remove(sosqId);
	}

	public static com.test.model.statusofsubmittedquote updateImpl(
		com.test.model.statusofsubmittedquote statusofsubmittedquote)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(statusofsubmittedquote);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.model.statusofsubmittedquote findByPrimaryKey(
		long sosqId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.NoSuchstatusofsubmittedquoteException {
		return getPersistence().findByPrimaryKey(sosqId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.model.statusofsubmittedquote fetchByPrimaryKey(
		long sosqId) throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(sosqId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.test.model.statusofsubmittedquote> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static statusofsubmittedquotePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (statusofsubmittedquotePersistence)PortletBeanLocatorUtil.locate(com.test.service.ClpSerializer.getServletContextName(),
					statusofsubmittedquotePersistence.class.getName());

			ReferenceRegistry.registerReference(statusofsubmittedquoteUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(statusofsubmittedquotePersistence persistence) {
	}

	private static statusofsubmittedquotePersistence _persistence;
}