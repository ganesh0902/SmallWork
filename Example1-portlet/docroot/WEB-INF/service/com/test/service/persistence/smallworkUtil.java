...
/**
 * The persistence utility for the smallwork service. This utility wraps {@link smallworkPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class smallworkUtil {
	 ...
	 */
	public static void clearCache(smallwork smallwork) {
		getPersistence().clearCache(smallwork);
	}
	 ...
	 */
	public static List<smallwork> findWithDynamicQuery(
	 ...
	 */
	public static smallwork update(smallwork smallwork)
		throws SystemException {
		return getPersistence().update(smallwork);
	}
	...
	public static smallwork update(smallwork smallwork,
		...
		return getPersistence().update(smallwork, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.test.model.smallwork smallwork) {
		getPersistence().cacheResult(smallwork);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.test.model.smallwork> smallworks) {
		getPersistence().cacheResult(smallworks);
	}
	...
	*/
	public static com.test.model.smallwork create(int id) {
	...
	*/
	public static com.test.model.smallwork remove(int id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.NoSuchsmallworkException {
		return getPersistence().remove(id);
	}

	public static com.test.model.smallwork updateImpl(
		com.test.model.smallwork smallwork)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(smallwork);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.model.smallwork findByPrimaryKey(int id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.NoSuchsmallworkException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.model.smallwork fetchByPrimaryKey(int id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.test.model.smallwork> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.test.model.smallwork> findAll(int start,
	...
	*/
	...
	public static smallworkPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (smallworkPersistence)PortletBeanLocatorUtil.locate(com.test.service.ClpSerializer.getServletContextName(),
					smallworkPersistence.class.getName());

			ReferenceRegistry.registerReference(smallworkUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(smallworkPersistence persistence) {
	}

	private static smallworkPersistence _persistence;
}